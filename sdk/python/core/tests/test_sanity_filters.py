...
class SanityYang(unittest.TestCase):
    ...
    def test_read_on_identity_ref(self):
        ...
        runner_read = self.crud.read(self.ncc, r_2)
        self.assertEqual(r_1.identity_ref_value.to_string(), runner_read.ytypes.built_in_t.identity_ref_value.to_string())
        self.assertEqual(type(r_1.identity_ref_value), type(runner_read.ytypes.built_in_t.identity_ref_value))
